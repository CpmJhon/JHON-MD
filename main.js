...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6285894955362@s.whatsapp.net`, {text: 'Sukses Tersambung\n\nScript Ini Di Tulis Ulang Oleh Miku ft Cpm_Jhon\nWhatsapp : wa.me/6285894955362' })
}
